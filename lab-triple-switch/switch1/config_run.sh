...
./behavioral-model/targets/simple_switch/simple_switch -i 0@eth0 -i 1@eth1 -i 2@eth2 --log-console /behavioral-model/targets/simple_switch/ipv4_forward.json --pcap &
sleep 10
echo "> no Ready!!"
