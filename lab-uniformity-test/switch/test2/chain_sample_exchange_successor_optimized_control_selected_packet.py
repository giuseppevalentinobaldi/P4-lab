...
def chain_sample(packet):
    ...
    # sample full
        ...
        if(array_succ_exp[tw] >= 2):
            ...
            # uniformity
            array_packet_count[entry.getIndexUniformity()] += 1
...
def writeOnFile(array):
        with open('/hosthome/git/P4-lab/lab-uniformity-test/testResults2/uniform.csv', 'w', newline='') as f:
